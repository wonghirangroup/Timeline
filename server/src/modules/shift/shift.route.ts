    ...
    schema: {
      ...
      body: {
        ...
        properties: {
          ...
          late_fine_1:      { type: ['number', 'null'], description: 'ค่าปรับสายระดับ 1 (บาท) — โหมด TIER' },
          late_fine_2:      { type: ['number', 'null'], description: 'ค่าปรับสายระดับ 2 (บาท) — โหมด TIER' },
          fine_mode:        { type: 'string', enum: ['TIER', 'PER_MINUTE'], description: 'TIER = คงที่ต่อระดับ · PER_MINUTE = หักตามนาทีที่สาย' },
          late_grace_minutes:   { type: ['integer', 'null'], minimum: 0, description: 'PER_MINUTE: นาทีผ่อนผันหลังเวลาเริ่มงาน' },
          late_fine_per_minute: { type: ['number', 'null'], description: 'PER_MINUTE: บาท/นาที' },
          late_fine_max:        { type: ['number', 'null'], description: 'PER_MINUTE: เพดานค่าปรับสายต่อวัน — null = ไม่จำกัด' },
    ...
    schema: {
      ...
      body: {
        ...
        properties: {
          ...
          fine_mode:        { type: 'string', enum: ['TIER', 'PER_MINUTE'] },
          late_grace_minutes:   { type: ['integer', 'null'], minimum: 0 },
          late_fine_per_minute: { type: ['number', 'null'] },
          late_fine_max:        { type: ['number', 'null'] },
