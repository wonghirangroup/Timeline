...
export async function leaveTypesRoutes(app: FastifyInstance) {
  ...
  app.get('/admin/leave-types', {
    preHandler: [tenantMiddleware, requireRole('SUPER_ADMIN', 'ADMIN', 'MANAGER', 'EXECUTIVE', 'DEPT_HEAD'), requirePermission('leave', 'view'), requireFeature('custom_leave_types')],
  ...
  app.post('/admin/leave-types', {
    preHandler: [tenantMiddleware, requireRole('SUPER_ADMIN', 'ADMIN', 'MANAGER'), requirePermission('leave', 'add'), requireFeature('custom_leave_types')],
    schema: {
  ...
  app.patch('/admin/leave-types/:id', {
    preHandler: [tenantMiddleware, requireRole('SUPER_ADMIN', 'ADMIN', 'MANAGER'), requirePermission('leave', 'edit'), requireFeature('custom_leave_types')],
  ...
  app.delete('/admin/leave-types/:id', {
    preHandler: [tenantMiddleware, requireRole('SUPER_ADMIN', 'ADMIN', 'MANAGER'), requirePermission('leave', 'delete'), requireFeature('custom_leave_types')],
  ...
  app.get('/admin/leave-accrual', {
    preHandler: [tenantMiddleware, requireRole('SUPER_ADMIN', 'ADMIN', 'MANAGER', 'EXECUTIVE'), requirePermission('leave', 'view'), requireFeature('leave_accrual')],
  ...
  app.put('/admin/leave-accrual', {
    preHandler: [tenantMiddleware, requireRole('SUPER_ADMIN', 'ADMIN'), requirePermission('leave', 'edit'), requireFeature('leave_accrual')],
    schema: {
  ...
  app.delete('/admin/leave-accrual/:id', {
    preHandler: [tenantMiddleware, requireRole('SUPER_ADMIN', 'ADMIN'), requirePermission('leave', 'delete'), requireFeature('leave_accrual')],
