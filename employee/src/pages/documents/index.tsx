      ...
      <div style={{ padding: '16px 16px 20px' }}>
        ...
        {!showForm ? (
          <button onClick={() => { setShowForm(true); setErrorMsg(null) }}
            style={{ width: '100%', padding: '14px', borderRadius: 14, border: `1.5px dashed ${COLOR.primary}`, background: '#F4F6F9', color: COLOR.primary, fontWeight: 700, fontSize: '0.9rem', cursor: 'pointer', fontFamily: 'inherit', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
              ...
              {TYPES.map(t => {
                ...
                return (
                  <button key={t.value} onClick={() => setType(t.value)}
                    style={{ padding: '12px 8px', borderRadius: 12, border: `2px solid ${isSelected ? COLOR.primary : 'transparent'}`, cursor: 'pointer', background: isSelected ? '#F4F6F9' : 'rgba(0,0,0,0.04)', transition: 'all 0.15s', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4, fontFamily: 'inherit' }}>
