      ...
      <div style={{ background: '#fff', borderRadius: 14, padding: 28, width: '100%', maxWidth: 400, boxShadow: '0 20px 60px rgba(0,0,0,0.3)' }}>
        ...
        <div style={{ display: 'grid', gap: 11 }}>
          ...
          <button onClick={() => mut.mutate()} disabled={!valid || mut.isPending}
            style={{ marginTop: 4, padding: '10px 18px', borderRadius: 8, border: 'none', background: '#244B83', color: '#fff', fontSize: '13.5px', fontWeight: 700, cursor: valid ? 'pointer' : 'not-allowed', opacity: valid && !mut.isPending ? 1 : 0.5 }}>
