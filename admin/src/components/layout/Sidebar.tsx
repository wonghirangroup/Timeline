...
const NAV_ITEMS: { path: string; label: string; icon: JSX.Element; feature?: keyof PlanFeatures }[] = [
  ...
  {
    path: '/shift-schedule', label: 'ตารางกะรายสัปดาห์',
    icon: <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.75} d="M3 10h18M3 6h18M3 14h18M3 18h18" /></svg>,
  },
  {
