...
export default function ShiftSchedulePage() {
  ...
  return (
    <div style={{ maxWidth: viewMode==='month'?1400:1100, margin:'0 auto' }}>
      ...
      {/* Pagination Controls */}
      {totalPages > 1 && (
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6, padding: '12px 16px', background: '#fff', borderRadius: 12, boxShadow: '0 2px 8px rgba(0,0,0,0.04)', border: '1px solid #E6ECF4', marginTop: 12 }}>
