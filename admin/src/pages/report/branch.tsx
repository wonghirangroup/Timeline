          ...
          {rows.map(r => (
            <div key={r.branch.id} style={{ background: '#fff', borderRadius: 14, border: '1px solid #E6ECF4', boxShadow: '0 2px 8px rgba(0,0,0,0.05)', padding: '14px 16px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 10 }}>
                <div style={{ width: 32, height: 32, borderRadius: 8, background: 'linear-gradient(135deg, #6581A8, #244B83)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                ...
                <tr key={r.branch.id} style={{ borderBottom: idx < rows.length - 1 ? '1px solid #E6ECF4' : 'none' }}>
                  <td style={{ padding: '10px 12px', fontWeight: 700, color: '#111827' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                      <div style={{ width: 26, height: 26, borderRadius: 8, background: 'linear-gradient(135deg, #6581A8, #244B83)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
