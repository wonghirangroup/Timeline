        ...
        {error ? (
          <>
            ...
            <button onClick={() => navigate('/login', { replace: true })}
              style={{ padding: '9px 20px', borderRadius: 8, border: 'none', background: '#EC6F44', color: '#fff', fontWeight: 700, fontSize: '13px', cursor: 'pointer' }}>
              ไปหน้าล็อกอิน
            </button>
          </>
        ) : (
          <>
            <Loader2 className="animate-spin" size={26} color="#EC6F44" style={{ margin: '0 auto 14px' }} />
