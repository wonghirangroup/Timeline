  ...
  return (
    ...
    <div style={{ background: '#fff', border: '1px solid #e2e8f0', borderRadius: 12, overflowX: 'auto' }}>
      ...
      {paginated.map((r: any, idx: number) => {
        ...
        const sc = STATUS_COLOR[r.status] ?? { color: '#64748b', bg: '#E6ECF4' }
        return (
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 20, flexWrap: 'wrap' }}>
          ...
          <div style={{ flex: 1, minWidth: 200 }}>
            ...
            <div style={{ display: 'flex', gap: 14, marginTop: 8, flexWrap: 'wrap', alignItems: 'center' }}>
              <span style={{ fontFamily: 'monospace', fontSize: '0.82rem', background: '#E6ECF4', padding: '3px 10px', borderRadius: 7, color: '#374151', fontWeight: 600 }}>{emp.employee_code}</span>
