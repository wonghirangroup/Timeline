  ...
  return (
    <div style={{ ...card, padding: 20 }}>
      <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12, marginBottom: 16 }}>
        <div style={{ width: 36, height: 36, borderRadius: 8, background: '#F4F6F9', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#244B83', flexShrink: 0 }}><Building2 size={18} /></div>
        <div>
      ...
      <div style={{ display: 'grid', gap: 12, gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))' }}>
        ...
        <div>
          ...
          <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
            <input type="color" disabled={readOnly} value={form.primary_color || '#244B83'} onChange={e => setForm(f => ({ ...f, primary_color: e.target.value }))} style={{ width: 44, height: 36, borderRadius: 8, border: '1px solid #e5e7eb', background: '#fff', cursor: readOnly ? 'default' : 'pointer' }} />
            <input style={{ ...inputStyle, flex: 1 }} value={form.primary_color} disabled={readOnly} onChange={e => setForm(f => ({ ...f, primary_color: e.target.value }))} placeholder="#244B83" />
          </div>
        </div>
      </div>
      {form.logo_url && (
    ...
    <div style={{ ...card, padding: 20, display: 'flex', flexDirection: 'column', gap: 12 }}>
      ...
      {[
        ...
        <Link key={i} to={s.to} style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '10px 12px', borderRadius: 10, background: '#f9fafb', textDecoration: 'none', color: 'inherit' }}>
          <div style={{ width: 32, height: 32, borderRadius: 8, background: '#F4F6F9', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#244B83', flexShrink: 0 }}>{s.icon}</div>
          <div style={{ flex: 1 }}>
