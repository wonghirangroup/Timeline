  ...
  return (
    <div style={{ background: '#e5e7eb', minHeight: '100vh' }}>
      ...
      <div className="no-print" style={{ position: 'sticky', top: 0, zIndex: 10, background: '#111827', color: '#fff', padding: '10px 20px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <button onClick={() => window.print()} disabled={!row} style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '8px 16px', borderRadius: 8, border: 'none', background: '#244B83', color: '#fff', fontWeight: 700, fontSize: '13px', cursor: row ? 'pointer' : 'not-allowed', opacity: row ? 1 : 0.6 }}>
