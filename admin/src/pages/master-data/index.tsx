...
const td: React.CSSProperties = {
  ...
  borderBottom: '1px solid #E6ECF4', whiteSpace: 'nowrap',
}
                  ...
                  return (
                    ...
                    >
                      <td style={{ ...td, position: 'sticky', left: 0, background: i % 2 === 0 ? '#fff' : '#fafafa' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                          <div style={{ width: 28, height: 28, borderRadius: '50%', overflow: 'hidden', background: e.photo_url ? '#e2e8f0' : '#F4F6F9', color: '#244B83', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.7rem', fontWeight: 700, flexShrink: 0 }}>
                            {e.photo_url
