...
export const MOCK_BRANCHES: Branch[] = [
  ...
  { id: 'br-02', name: 'ฟุคุโระ แม่กิมเฮง',           address: '173 ถ. สุรนารี ตำบลในเมือง อำเภอเมืองนครราชสีมา นครราชสีมา 30000',                  lat: 14.976407395813236, lng: 102.0953132316107,  employee_count: 2,  radius_m: 150 },
  { id: 'br-03', name: 'ฟุคุโระ ตลาดย่าโม',           address: 'X3GH+PMW ตำบลในเมือง อำเภอเมืองนครราชสีมา นครราชสีมา 30000',                        lat: 14.976832134706047, lng: 102.07916957731089, employee_count: 2,  radius_m: 150 },
  { id: 'br-04', name: 'ฟุคุโระ ไนท์สวนหมาก',        address: '99 ถ. สวนหมาก อำเภอเมืองนครราชสีมา นครราชสีมา 30000',                               lat: 14.9723,            lng: 102.1012,           employee_count: 6,  radius_m: 150 },
  ...
  { id: 'br-06', name: 'ฟุคุโระ เทิดไท',             address: '12 ถ. เทิดไท ตำบลในเมือง อำเภอเมืองนครราชสีมา นครราชสีมา 30000',                     lat: 14.9634,            lng: 102.1143,           employee_count: 2,  radius_m: 150 },
]

// ── Employees ─────────────────────────────────────────────────────────────────
export const MOCK_EMPLOYEES: Employee[] = [
  // วันทำงาน: [1-6]=จ-ส, [1-5]=จ-ศ  |  default_shift_id = กะที่ใช้ประจำ (fallback อัตโนมัติ)
  { id: 'e01', code: '58-01-001', full_name: 'ชาตรี วงษ์วิบูลย์สิน',   nickname: 'ตอง',      department: 'แผนกผู้บริหาร / กรรมการ', branches: ['วงษ์หิรัญ'],                                             phone: '0891234561', hire_date: '2015-01-01', status: 'ACTIVE',   line_user_id: 'Ua1b2c3d4e5f6789012345678901234ab', pay_type: 'MONTHLY', default_shift_id: 'sh-01', default_work_days: [1,2,3,4,5,6] },
  { id: 'e02', code: '58-01-002', full_name: 'เกาไพรรา หิรัญประทีป',   nickname: 'ที่จิ๋ว',   department: 'แผนกผู้บริหาร / กรรมการ', branches: ['วงษ์หิรัญ'],                                             phone: '0891234562', hire_date: '2015-01-01', status: 'ACTIVE',   line_user_id: 'Ub2c3d4e5f6789012345678901234abcd', pay_type: 'MONTHLY', default_shift_id: 'sh-01', default_work_days: [1,2,3,4,5,6] },
  { id: 'e03', code: '59-03-001', full_name: 'ศุภนุช จึงอนุวัตร',      nickname: 'พิม',       department: 'พนักงานขาย',              branches: ['วงษ์หิรัญ', 'ฟุคุโระ ไนท์สวนหมาก'],                  phone: '0891234563', hire_date: '2016-07-01', status: 'ACTIVE',   line_user_id: 'Uc3d4e5f6789012345678901234abcde', pay_type: 'MONTHLY', default_shift_id: 'sh-01', default_work_days: [1,2,3,4,5,6] },
  { id: 'e04', code: '60-03-001', full_name: 'นวลละออ โพธิ์สูงเนิน',   nickname: 'ปุ้ย',      department: 'พนักงานขาย',              branches: ['ฟุคุโระ ไนท์สวนหมาก'],                                 phone: '0891234564', hire_date: '2017-01-04', status: 'ACTIVE',   line_user_id: 'Ud4e5f6789012345678901234abcdef1', pay_type: 'MONTHLY', default_shift_id: 'sh-05', default_work_days: [1,2,3,4,5,6] },
  { id: 'e05', code: '63-03-001', full_name: 'มณเฑียร สว่างเมฆ',       nickname: 'เฟิร์ส',   department: 'พนักงานขาย',              branches: ['ฟุคุโระ แม่กิมเฮง', 'ฟุคุโระ ไนท์สวนหมาก'],          phone: '0891234565', hire_date: '2020-11-01', status: 'ACTIVE',   line_user_id: null,                                pay_type: 'HOURLY',  hourly_rate: 65, default_shift_id: 'sh-03', default_work_days: [1,2,3,4,5] },
  { id: 'e06', code: '63-04-001', full_name: 'สิรีธร จึงอนุวัตร',      nickname: 'กุล',       department: 'พนักงานขนส่ง',            branches: ['วงษ์หิรัญ', 'ฟุคุโระ ไนท์สวนหมาก'],                  phone: '0891234566', hire_date: '2020-02-17', status: 'ACTIVE',   line_user_id: 'Uf6789012345678901234abcdef12345', pay_type: 'MONTHLY', default_shift_id: 'sh-05', default_work_days: [1,2,3,4,5,6] },
  { id: 'e07', code: '64-02-001', full_name: 'อมรรัตน์ โชติมณี',       nickname: 'ปิ๊ว',      department: 'Office',                  branches: ['วงษ์หิรัญ'],                                             phone: '0891234567', hire_date: '2021-09-01', status: 'ACTIVE',   line_user_id: null,                                pay_type: 'MONTHLY', default_shift_id: 'sh-01', default_work_days: [1,2,3,4,5] },
  { id: 'e08', code: '65-03-001', full_name: 'สนธิญา เลื่อนกระโทก',   nickname: 'มิลส์',    department: 'พนักงานขาย',              branches: ['ฟุคุโระ แม่กิมเฮง', 'ฟุคุโระ ไนท์สวนหมาก', 'วงษ์หิรัญ'], phone: '0891234568', hire_date: '2022-01-11', status: 'ACTIVE',   line_user_id: 'Ug789012345678901234abcdef123456', pay_type: 'MONTHLY', default_shift_id: 'sh-01', default_work_days: [1,2,3,4,5,6] },
  { id: 'e09', code: '66-03-001', full_name: 'ปัทมา ปลั่งกลาง',        nickname: 'แพร',       department: 'พนักงานขาย',              branches: ['ฟุคุโระ ตลาดย่าโม'],                                   phone: '0891234569', hire_date: '2023-03-01', status: 'ACTIVE',   line_user_id: null,                                pay_type: 'MONTHLY', default_shift_id: 'sh-04', default_work_days: [1,2,3,4,5,6] },
  { id: 'e10', code: '67-03-002', full_name: 'ลัดดาวัลย์ ปอกระโทก',   nickname: 'แป้ว',      department: 'พนักงานขาย',              branches: ['ฟุคุโระ เทิดไท'],                                      phone: '0891234570', hire_date: '2024-01-01', status: 'ACTIVE',   line_user_id: null,                                pay_type: 'DAILY',   default_shift_id: 'sh-06', default_work_days: [1,2,3,4,5,6] },
  { id: 'e11', code: '59-03-001', full_name: 'ศุภนุช จึงอนุวัตร',      nickname: 'พิม',       department: 'พนักงานขาย',              branches: ['ฟุคุโระ ไนท์สวนหมาก'],                                 phone: '0891234571', hire_date: '2016-07-01', status: 'ACTIVE',   line_user_id: 'Uh89012345678901234abcdef1234567', pay_type: 'MONTHLY', default_shift_id: 'sh-05', default_work_days: [1,2,3,4,5,6] },
  { id: 'e12', code: '68-03-004', full_name: 'ณัฐธิชา พิมพ์สระเกตุ',  nickname: 'สมาย',     department: 'พนักงานขาย',              branches: ['วงษ์หิรัญ'],                                             phone: '0891234572', hire_date: '2025-01-01', status: 'ACTIVE',   line_user_id: null,                                pay_type: 'DAILY',   default_shift_id: 'sh-01', default_work_days: [1,2,3,4,5,6] },
  { id: 'e13', code: '68-03-006', full_name: 'ศรัญญา ถาวิชัย',         nickname: 'น้ำ สาขา', department: 'พนักงานขาย',              branches: ['ฟุคุโระ ไนท์สวนหมาก'],                                 phone: '0891234573', hire_date: '2025-03-01', status: 'ACTIVE',   line_user_id: null,                                pay_type: 'HOURLY',  hourly_rate: 60, default_shift_id: 'sh-05', default_work_days: [1,2,3,4,5,6] },
]

// ── Today Attendance ──────────────────────────────────────────────────────────
export const MOCK_TODAY_ATTENDANCE: AttendanceRow[] = [
  { id: 'a01', code: '68-03-006', full_name: 'ศรัญญา ถาวิชัย',        nickname: 'น้ำ สาขา',  branch_name: 'ฟุคุโระ ไนท์สวนหมาก', shift_no: 1, check_in_time: '09:55', check_out_time: null, status: 'ON_TIME', fine: 0 },
  { id: 'a02', code: '66-03-001', full_name: 'ปัทมา ปลั่งกลาง',       nickname: 'แพร',        branch_name: 'ฟุคุโระ ตลาดย่าโม',   shift_no: 1, check_in_time: '09:47', check_out_time: null, status: 'ON_TIME', fine: 0 },
  { id: 'a03', code: '67-03-002', full_name: 'ลัดดาวัลย์ ปอกระโทก',  nickname: 'แป้ว',       branch_name: 'ฟุคุโระ เทิดไท',       shift_no: 1, check_in_time: '09:45', check_out_time: null, status: 'ON_TIME', fine: 0 },
  { id: 'a04', code: '63-04-001', full_name: 'สิรีธร จึงอนุวัตร',     nickname: 'กุล',        branch_name: 'ฟุคุโระ ไนท์สวนหมาก', shift_no: 2, check_in_time: '09:10', check_out_time: null, status: 'ON_TIME', fine: 0 },
  { id: 'a05', code: '59-03-001', full_name: 'ศุภนุช จึงอนุวัตร',     nickname: 'พิม',        branch_name: 'ฟุคุโระ ไนท์สวนหมาก', shift_no: 2, check_in_time: '09:09', check_out_time: null, status: 'ON_TIME', fine: 0 },
  ...
  { id: 'a09', code: '60-03-001', full_name: 'นวลละออ โพธิ์สูงเนิน',  nickname: 'ปุ้ย',       branch_name: 'ฟุคุโระ ไนท์สวนหมาก', shift_no: 1, check_in_time: '07:59', check_out_time: null, status: 'ON_TIME', fine: 0 },
  { id: 'a10', code: '63-03-001', full_name: 'มณเฑียร สว่างเมฆ',      nickname: 'เฟิร์ส',    branch_name: 'ฟุคุโระ แม่กิมเฮง',    shift_no: 1, check_in_time: null,    check_out_time: null, status: 'LEAVE',   fine: 0 },
...
export const MOCK_OT_REQUESTS: OtRequest[] = [
  ...
  { id: 'ot-02', employee_id: 'e04', full_name: 'นวลละออ โพธิ์สูงเนิน', nickname: 'ปุ้ย',   branch_name: 'ฟุคุโระ ไนท์สวนหมาก', date: '2026-05-17', start_time: '17:00', end_time: '18:30', hours: 1.5, multiplier: 1.5, amount: 0, note: 'จัดสต็อกสินค้า',    status: 'PENDING'  },
  { id: 'ot-03', employee_id: 'e09', full_name: 'ปัทมา ปลั่งกลาง',      nickname: 'แพร',    branch_name: 'ฟุคุโระ ตลาดย่าโม',   date: '2026-05-12', start_time: '18:00', end_time: '20:00', hours: 2,   multiplier: 1.5, amount: 0, note: 'ประชุมยอดขาย',       status: 'REJECTED' },
  ...
  { id: 'ot-09', employee_id: 'e06', full_name: 'สิรีธร จึงอนุวัตร',      nickname: 'กุล',    branch_name: 'ฟุคุโระ ไนท์สวนหมาก', date: '2026-05-25', start_time: '02:00', end_time: '12:00', hours: 10,  multiplier: 2.0, amount: 0, note: 'กะดึกสาขาไนท์',      status: 'APPROVED' },
  { id: 'ot-10', employee_id: 'e06', full_name: 'สิรีธร จึงอนุวัตร',      nickname: 'กุล',    branch_name: 'ฟุคุโระ ไนท์สวนหมาก', date: '2026-05-26', start_time: '02:00', end_time: '12:00', hours: 10,  multiplier: 2.0, amount: 0, note: 'กะดึกสาขาไนท์',      status: 'APPROVED' },
  { id: 'ot-11', employee_id: 'e06', full_name: 'สิรีธร จึงอนุวัตร',      nickname: 'กุล',    branch_name: 'ฟุคุโระ ไนท์สวนหมาก', date: '2026-05-27', start_time: '02:00', end_time: '12:00', hours: 10,  multiplier: 2.0, amount: 0, note: 'กะดึกสาขาไนท์',      status: 'APPROVED' },
  { id: 'ot-12', employee_id: 'e06', full_name: 'สิรีธร จึงอนุวัตร',      nickname: 'กุล',    branch_name: 'ฟุคุโระ ไนท์สวนหมาก', date: '2026-05-28', start_time: '02:00', end_time: '08:00', hours: 6,   multiplier: 2.0, amount: 0, note: 'กะดึกสาขาไนท์',      status: 'APPROVED' },
  { id: 'ot-13', employee_id: 'e06', full_name: 'สิรีธร จึงอนุวัตร',      nickname: 'กุล',    branch_name: 'ฟุคุโระ ไนท์สวนหมาก', date: '2026-05-29', start_time: '02:00', end_time: '06:00', hours: 4,   multiplier: 2.0, amount: 0, note: 'กะดึกสาขาไนท์',      status: 'PENDING'  },
...
export const MOCK_SHIFTS: ShiftDef[] = [
  ...
  { id: 'sh-03', name: 'กะเช้า', branch_name: 'ฟุคุโระ แม่กิมเฮง',   start_time: '09:00', end_time: '18:00', late_threshold_1: '09:05', late_threshold_2: '09:30', employee_count: 2  },
  { id: 'sh-04', name: 'กะเช้า', branch_name: 'ฟุคุโระ ตลาดย่าโม',   start_time: '09:00', end_time: '18:00', late_threshold_1: '09:05', late_threshold_2: '09:30', employee_count: 2  },
  { id: 'sh-05', name: 'กะกลางคืน', branch_name: 'ฟุคุโระ ไนท์สวนหมาก', start_time: '17:00', end_time: '02:00', late_threshold_1: '17:05', late_threshold_2: '17:30', employee_count: 6  },
  { id: 'sh-06', name: 'กะเช้า', branch_name: 'ฟุคุโระ เทิดไท',      start_time: '09:00', end_time: '18:00', late_threshold_1: '09:05', late_threshold_2: '09:30', employee_count: 2  },
]
...
export const MOCK_LEAVE_REQUESTS: LeaveRequest[] = [
  ...
  { id: 'lv-02', full_name: 'ปัทมา ปลั่งกลาง',      nickname: 'แพร',    branch_name: 'ฟุคุโระ ตลาดย่าโม',   leave_type: 'ลาป่วย',      leave_type_color: '#16a34a', start_date: '2026-05-10', end_date: '2026-05-10', days: 1,   half_day_period: null, reason: 'ไม่สบาย มีไข้',      status: 'APPROVED', created_at: '2026-05-09T18:00:00' },
  ...
  { id: 'lv-04', full_name: 'มณเฑียร สว่างเมฆ',     nickname: 'เฟิร์ส', branch_name: 'ฟุคุโระ แม่กิมเฮง',   leave_type: 'ลาป่วย',      leave_type_color: '#16a34a', start_date: '2026-05-10', end_date: '2026-05-10', days: 1,   half_day_period: null, reason: 'หมอนัด',             status: 'PENDING',  created_at: '2026-05-09T07:00:00' },
  { id: 'lv-05', full_name: 'ลัดดาวัลย์ ปอกระโทก',  nickname: 'แป้ว',   branch_name: 'ฟุคุโระ เทิดไท',       leave_type: 'ลากิจ',       leave_type_color: '#8b5cf6', start_date: '2026-05-15', end_date: '2026-05-15', days: 1,   half_day_period: null, reason: 'ต่อทะเบียนรถ',       status: 'REJECTED', created_at: '2026-05-14T08:00:00' },
  ...
  { id: 'lv-07', full_name: 'สิรีธร จึงอนุวัตร',    nickname: 'กุล',    branch_name: 'ฟุคุโระ ไนท์สวนหมาก', leave_type: 'ลาครึ่งวัน',  leave_type_color: '#0891b2', start_date: '2026-05-22', end_date: '2026-05-22', days: 0.5, half_day_period: 'PM',  reason: 'ธุระบ่าย',            status: 'APPROVED', created_at: '2026-05-19T09:00:00' },
]
...
export const MOCK_LEAVE_BALANCES: LeaveBalance[] = [
  ...
  { employee_id: 'e04', full_name: 'นวลละออ โพธิ์สูงเนิน',   nickname: 'ปุ้ย',    branch_name: 'ฟุคุโระ ไนท์สวนหมาก', sick_used: 3, sick_quota: 30, personal_used: 0, personal_quota: 3, vacation_used: 2,  vacation_quota: 7,  compensate_used: 0, compensate_quota: 1 },
  { employee_id: 'e05', full_name: 'มณเฑียร สว่างเมฆ',       nickname: 'เฟิร์ส',  branch_name: 'ฟุคุโระ แม่กิมเฮง',   sick_used: 5, sick_quota: 30, personal_used: 2, personal_quota: 3, vacation_used: 0,  vacation_quota: 6,  compensate_used: 0, compensate_quota: 0 },
  { employee_id: 'e06', full_name: 'สิรีธร จึงอนุวัตร',      nickname: 'กุล',     branch_name: 'ฟุคุโระ ไนท์สวนหมาก', sick_used: 1, sick_quota: 30, personal_used: 1, personal_quota: 3, vacation_used: 5,  vacation_quota: 7,  compensate_used: 2, compensate_quota: 3 },
  ...
  { employee_id: 'e09', full_name: 'ปัทมา ปลั่งกลาง',        nickname: 'แพร',     branch_name: 'ฟุคุโระ ตลาดย่าโม',   sick_used: 1, sick_quota: 30, personal_used: 1, personal_quota: 3, vacation_used: 0,  vacation_quota: 5,  compensate_used: 0, compensate_quota: 0 },
  { employee_id: 'e10', full_name: 'ลัดดาวัลย์ ปอกระโทก',   nickname: 'แป้ว',    branch_name: 'ฟุคุโระ เทิดไท',       sick_used: 2, sick_quota: 30, personal_used: 0, personal_quota: 3, vacation_used: 0,  vacation_quota: 3,  compensate_used: 0, compensate_quota: 0 },
  ...
  { employee_id: 'e13', full_name: 'ศรัญญา ถาวิชัย',         nickname: 'น้ำ สาขา',branch_name: 'ฟุคุโระ ไนท์สวนหมาก', sick_used: 0, sick_quota: 30, personal_used: 0, personal_quota: 3, vacation_used: 0,  vacation_quota: 3,  compensate_used: 0, compensate_quota: 0 },
]
...
export const MOCK_WEEKLY_OFF_BOOKINGS: WeeklyOffBooking[] = [
  ...
  { id: 'wo-04', employee_id: 'e04', full_name: 'นวลละออ โพธิ์สูงเนิน',  nickname: 'ปุ้ย',     branch_name: 'ฟุคุโระ ไนท์สวนหมาก', week_start: '2026-05-25', day_of_week: 3, status: 'APPROVED', created_at: '2026-05-20T10:15:00' },
  ...
  { id: 'wo-09', employee_id: 'e09', full_name: 'ปัทมา ปลั่งกลาง',       nickname: 'แพร',      branch_name: 'ฟุคุโระ ตลาดย่าโม',   week_start: '2026-05-25', day_of_week: 4, status: 'APPROVED', created_at: '2026-05-20T11:00:00' },
  { id: 'wo-10', employee_id: 'e10', full_name: 'ลัดดาวัลย์ ปอกระโทก',  nickname: 'แป้ว',     branch_name: 'ฟุคุโระ เทิดไท',       week_start: '2026-05-25', day_of_week: 5, status: 'APPROVED', created_at: '2026-05-20T11:10:00' },
  { id: 'wo-11', employee_id: 'e11', full_name: 'ศุภนุช จึงอนุวัตร',     nickname: 'พิม',      branch_name: 'ฟุคุโระ ไนท์สวนหมาก', week_start: '2026-05-25', day_of_week: 5, status: 'PENDING',  created_at: '2026-05-22T15:00:00' },
  ...
  { id: 'wo-15', employee_id: 'e04', full_name: 'นวลละออ โพธิ์สูงเนิน',  nickname: 'ปุ้ย',     branch_name: 'ฟุคุโระ ไนท์สวนหมาก', week_start: '2026-06-01', day_of_week: 1, status: 'PENDING',  created_at: '2026-05-23T11:00:00' },
]
