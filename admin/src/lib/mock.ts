...
export const MOCK_EMPLOYEES: Employee[] = [
  ...
  { id: 'e03', code: '59-03-001', full_name: 'ศุภนุช จึงอนุวัตร',      nickname: 'พิม',       department: 'พนักงานขาย',              branches: ['วงษ์หิรัญ', 'ฟุ๊ดโรห์ ไนท์สวนหมาก'],                  phone: '0891234563', hire_date: '2016-07-01', status: 'ACTIVE',   line_user_id: 'Uc3d4e5f6789012345678901234abcde', pay_type: 'MONTHLY', default_shift_id: 'sh-01', default_work_days: [1,2,3,4,5,6] },
  { id: 'e04', code: '60-03-001', full_name: 'นวลละออ โพธิ์สูงเนิน',   nickname: 'ปุ้ย',      department: 'พนักงานขาย',              branches: ['ฟุ๊ดโรห์ ไนท์สวนหมาก'],                                 phone: '0891234564', hire_date: '2017-01-04', status: 'ACTIVE',   line_user_id: 'Ud4e5f6789012345678901234abcdef1', pay_type: 'MONTHLY', default_shift_id: 'sh-05', default_work_days: [1,2,3,4,5,6] },
  { id: 'e05', code: '63-03-001', full_name: 'มณเฑียร สว่างเมฆ',       nickname: 'เฟิร์ส',   department: 'พนักงานขาย',              branches: ['ฟุ๊ดโรห์ แม่กิมเฮง', 'ฟุ๊ดโรห์ ไนท์สวนหมาก'],          phone: '0891234565', hire_date: '2020-11-01', status: 'ACTIVE',   line_user_id: null,                                pay_type: 'HOURLY',  hourly_rate: 65, default_shift_id: 'sh-03', default_work_days: [1,2,3,4,5] },
  { id: 'e06', code: '63-04-001', full_name: 'สิรีธร จึงอนุวัตร',      nickname: 'กุล',       department: 'พนักงานขนส่ง',            branches: ['วงษ์หิรัญ', 'ฟุ๊ดโรห์ ไนท์สวนหมาก'],                  phone: '0891234566', hire_date: '2020-02-17', status: 'ACTIVE',   line_user_id: 'Uf6789012345678901234abcdef12345', pay_type: 'MONTHLY', default_shift_id: 'sh-05', default_work_days: [1,2,3,4,5,6] },
  ...
  { id: 'e08', code: '65-03-001', full_name: 'สนธิญา เลื่อนกระโทก',   nickname: 'มิลส์',    department: 'พนักงานขาย',              branches: ['ฟุ๊ดโรห์ แม่กิมเฮง', 'ฟุ๊ดโรห์ ไนท์สวนหมาก', 'วงษ์หิรัญ'], phone: '0891234568', hire_date: '2022-01-11', status: 'ACTIVE',   line_user_id: 'Ug789012345678901234abcdef123456', pay_type: 'MONTHLY', default_shift_id: 'sh-01', default_work_days: [1,2,3,4,5,6] },
  { id: 'e09', code: '66-03-001', full_name: 'ปัทมา ปลั่งกลาง',        nickname: 'แพร',       department: 'พนักงานขาย',              branches: ['ฟุ๊ดโรห์ ตลาดย่าโม'],                                   phone: '0891234569', hire_date: '2023-03-01', status: 'ACTIVE',   line_user_id: null,                                pay_type: 'MONTHLY', default_shift_id: 'sh-04', default_work_days: [1,2,3,4,5,6] },
  { id: 'e10', code: '67-03-002', full_name: 'ลัดดาวัลย์ ปอกระโทก',   nickname: 'แป้ว',      department: 'พนักงานขาย',              branches: ['ฟุ๊ดโรห์ เทิดไท'],                                      phone: '0891234570', hire_date: '2024-01-01', status: 'ACTIVE',   line_user_id: null,                                pay_type: 'DAILY',   default_shift_id: 'sh-06', default_work_days: [1,2,3,4,5,6] },
  { id: 'e11', code: '59-03-001', full_name: 'ศุภนุช จึงอนุวัตร',      nickname: 'พิม',       department: 'พนักงานขาย',              branches: ['ฟุ๊ดโรห์ ไนท์สวนหมาก'],                                 phone: '0891234571', hire_date: '2016-07-01', status: 'ACTIVE',   line_user_id: 'Uh89012345678901234abcdef1234567', pay_type: 'MONTHLY', default_shift_id: 'sh-05', default_work_days: [1,2,3,4,5,6] },
  ...
  { id: 'e13', code: '68-03-006', full_name: 'ศรัญญา ถาวิชัย',         nickname: 'น้ำ สาขา', department: 'พนักงานขาย',              branches: ['ฟุ๊ดโรห์ ไนท์สวนหมาก'],                                 phone: '0891234573', hire_date: '2025-03-01', status: 'ACTIVE',   line_user_id: null,                                pay_type: 'HOURLY',  hourly_rate: 60, default_shift_id: 'sh-05', default_work_days: [1,2,3,4,5,6] },
]
