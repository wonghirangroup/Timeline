...
export const MOCK_OT_REQUESTS: OtRequest[] = [
  { id: 'ot-01', employee_id: 'e03', full_name: 'ศุภนุช จึงอนุวัตร',     nickname: 'พิม',    branch_name: 'วงษ์หิรัญ',             date: '2026-05-15', start_time: '17:00', end_time: '19:00', hours: 2,   multiplier: 1.5, amount: 300,  note: 'ปิดงบประจำเดือน',      status: 'APPROVED' },
  { id: 'ot-02', employee_id: 'e06', full_name: 'สิรีธร จึงอนุวัตร',     nickname: 'กุล',    branch_name: 'ฟุ๊ดโรห์ ไนท์สวนหมาก', date: '2026-05-08', start_time: '17:00', end_time: '20:00', hours: 3,   multiplier: 1.5, amount: 450,  note: 'เตรียมงาน Event',      status: 'APPROVED' },
  { id: 'ot-03', employee_id: 'e08', full_name: 'สนธิญา เลื่อนกระโทก', nickname: 'มิลส์',  branch_name: 'วงษ์หิรัญ',             date: '2026-05-18', start_time: '17:00', end_time: '19:30', hours: 2.5, multiplier: 1.5, amount: 375,  note: 'รอลูกค้าเซ็นสัญญา',  status: 'PENDING'  },
  { id: 'ot-04', employee_id: 'e04', full_name: 'นวลละออ โพธิ์สูงเนิน', nickname: 'ปุ้ย',   branch_name: 'ฟุ๊ดโรห์ ไนท์สวนหมาก', date: '2026-05-17', start_time: '17:00', end_time: '18:30', hours: 1.5, multiplier: 1.5, amount: 225,  note: 'จัดสต็อกสินค้า',      status: 'PENDING'  },
  { id: 'ot-05', employee_id: 'e09', full_name: 'ปัทมา ปลั่งกลาง',      nickname: 'แพร',    branch_name: 'ฟุ๊ดโรห์ ตลาดย่าโม',   date: '2026-05-12', start_time: '18:00', end_time: '20:00', hours: 2,   multiplier: 1.5, amount: 300,  note: 'ประชุมยอดขาย',         status: 'REJECTED' },
  { id: 'ot-06', employee_id: 'e12', full_name: 'ณัฐธิชา พิมพ์สระเกตุ', nickname: 'สมาย',   branch_name: 'วงษ์หิรัญ',             date: '2026-05-16', start_time: '17:00', end_time: '19:00', hours: 2,   multiplier: 2.0, amount: 400,  note: 'วันหยุด OT x2',       status: 'PENDING'  },
]
